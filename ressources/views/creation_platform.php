...
<div>
    ...
    <form class="bg-slate-100 w-2/4 mx-auto mt-20 p-4 rounded-xl" action="dashboard_controller.php" method="post">
        ...
        <div class="flex mt-4">
            <button type="submit" name="create_platform" class="text-white bg-[#2CE6C1] hover:bg-[#BAE1FE] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Enregistrer</button>
        </div>
    </form>
