    ...
    <div class="flex justify-center mt-6 border-t border-gray-100  ">
      ...
      <div class="flex justify-center mt-6">
        <div x-data="{ showModal: false }">
          <div class="flex justify-center mt-6">
              <button @click="showModal = true" class="text-white bg-[#2CE6C1] hover:bg-[#BAE1FE] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center mr-4">Modifier les informations</button>
            ...
            <button type="submit" class="text-white bg-[#2CE6C1] hover:bg-[#BAE1FE] focus:ring-4 focus:outline-none focus:ring-blue-300 mt-6 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Enregistrer</button>
            </form>
    </div>
  </div>
</div>
