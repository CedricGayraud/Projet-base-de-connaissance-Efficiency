            ...
            <div class="bg-black rounded-lg">
                ...
                <form action="../Controller/commentController.php" method="post">
                    ...
                    <?php if (isset($_SESSION['user']) && $sessionUser->getRole() == 1) { ?>
                        ...
                        <button type="submit" name="edit_code" class="m-4 text-white bg-[#2CE6C1] hover-bg-[#BAE1FE] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center mt-4">Enregistrer</button>
                    <?php } else { ?>
                        <div class="text-center py-3 px-8">
