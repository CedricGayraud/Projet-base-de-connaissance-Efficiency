<footer class="bg-gray-900 h-56" aria-labelledby="footer-heading">
        ...
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
            <div class="grid grid-cols-2 gap-8 xl:col-span-2">
                <div class="md:grid md:grid-cols-2 md:gap-8">
                    <div>
                        <img class="ml-32 w-36" src="https://image.noelshack.com/fichiers/2023/39/3/1695825191-logo-efficiency-blanc.png" alt="">
                    </div>
                </div>
            </div>
            <div class="mt-10 xl:mt-0">
                ...
                <form class="mt-2" action="ressources/views/footer_controller.php" method="post">
                    <div class="sm:flex sm:max-w-md mb-2">
                        <input type="email" name="email" autocomplete="email" required class="mr-2 w-full min-w-0 appearance-none rounded-md border-0 bg-white/5 px-3 py-1.5 text-base text-white shadow-sm ring-1 ring-inset ring-white/10 placeholder:text-gray-500 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:w-64 sm:text-sm sm:leading-6 xl:w-full" placeholder="Votre email">
                        <input type="text" name="name" autocomplete="name" required class="w-full min-w-0 appearance-none rounded-md border-0 bg-white/5 px-3 py-1.5 text-base text-white shadow-sm ring-1 ring-inset ring-white/10 placeholder:text-gray-500 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:w-64 sm:text-sm sm:leading-6 xl:w-full" placeholder="Votre nom">
                    </div>
