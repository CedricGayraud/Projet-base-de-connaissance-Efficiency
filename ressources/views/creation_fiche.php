...
<div x-data="{ showConfirmation: false }" class="my-20">
    ...
    ?>
        ...
        <form class="bg-slate-100 w-2/4 mx-auto mt-10 p-4 rounded-xl shadow-md" action="creation_fiche_controller.php" method="post">
            <div class="flex justify-center">
                ...
                <div class="w-2/4 m-4">
                    ...
                    <input type="text" name="cardTitle" class="bg-gray-50 border-2 border-[#2CE6C1] text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white focus:outline-none focus:ring focus:ring-[#BAE1FE]" required>
                </div>
                <div class="w-2/4 m-4">
                    <label for="cardSummary" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Résumé</label>
                    <input type="text" name="cardSummary" class="bg-gray-50 border-2 border-[#2CE6C1] text-gray-900 text-sm rounded-lg block w-full p-2.5 focus:outline-none focus:ring focus:ring-[#BAE1FE]" required>
                </div>
            ...
            <div class="flex justify-center">
                <div class="w-2/4 m-4">
                    ...
                    <select name="cardPlateforme" autocomplete="country-name" class="block w-full rounded-md border-2 border-[#2CE6C1] p-2.5 text-gray-900 shadow-sm focus:outline-none focus:ring focus:ring-[#BAE1FE] sm:max-w-xs sm:text-sm sm:leading-6">
                ...
                <div class="w-2/4 m-4">
                    ...
                    <select name="cardTheme" autocomplete="country-name" class="block w-full rounded-md border-2 border-[#2CE6C1] p-2.5 text-gray-900 shadow-sm focus:outline-none focus:ring focus:ring-[#BAE1FE] sm:max-w-xs sm:text-sm sm:leading-6">
            ...
            <div class="m-4">
                ...
                <input type="text" name="cardGitHub" class="bg-gray-50 border-2 border-[#2CE6C1] text-gray-900 text-sm rounded-lg focus:outline-none focus:ring focus:ring-[#BAE1FE] block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                </input>
            </div>
