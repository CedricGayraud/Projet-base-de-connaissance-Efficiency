...
<div>
    ...
    <div x-data="{ isSmall: true }">
        <!-- Small sidebar -->
        <div x-show="isSmall" x-transition:enter="transition-transform transition-opacity ease-in-out duration-300" x-transition:enter-start="transform translate-x-[-100%] opacity-0" x-transition:enter-end="transform translate-x-0 opacity-100" x-transition:leave="transition-transform transition-opacity ease-in-out duration-300" x-transition:leave-start="transform translate-x-0 opacity-100" x-transition:leave-end="transform translate-x-[100%] opacity-0" @mouseenter="isSmall = false" class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-16 lg:flex-col">
            <!-- Sidebar component, swap this element with another sidebar if you like -->
        ...
        <!-- big sidebar -->
        <!-- Static sidebar for desktop -->
        <div x-show="!isSmall" x-transition:enter="transition-transform transition-opacity ease-in-out duration-300" x-transition:enter-start="transform translate-x-[-100%] opacity-0" x-transition:enter-end="transform translate-x-0 opacity-100" x-transition:leave="transition-transform transition-opacity ease-in-out duration-300" x-transition:leave-start="transform translate-x-0 opacity-100" x-transition:leave-end="transform translate-x-[100%] opacity-0" @mouseleave="isSmall = true" class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
            <!-- Sidebar component, swap this element with another sidebar if you like -->
            <div class="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6">
                <div class="flex h-16 shrink-0 items-center">
                    <img class="h-8 w-auto" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600" alt="Your Company">
